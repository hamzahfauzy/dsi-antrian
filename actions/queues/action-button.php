...
if(Session::get('pos') && $d->status == 'menunggu')
{
    ...
    return '<button class="btn btn-success" onclick="responsiveVoice.speak(\'Panggilan Kepada, Nomor Antrian '.$d->number.', untuk pelayanan '.$service->name.'. Agar segera datang ke, '.$pos->name.'\',\'Indonesian Female\');">Panggil</button>
