...
<head>
	...
	<link rel="icon" href="<?= routeTo('assets/img/logo-bwhite.webp')?>" type="image/x-icon"/>
        ...
        <div class="row mt-4">
            <div class="col-sm-12 col-md-6 col-lg-4 mx-auto">
                <div class="card full-height">
                    ...
                    <div class="card-body">
                        <center>
                            <img src="<?=routeTo('assets/img/logo-bwhite.webp')?>" width="150px" height="100px" alt="logo" style="object-fit:contain;">
                        </center>
