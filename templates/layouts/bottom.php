...
<!-- End Custom template -->
	...
	<script>
		...
		Circles.create({
			...
			width:10,
			text: <?=$survey_total ? number_format(($survey_tidak_memuaskan/$survey_total)*100,0) : 0?>+'%',
		...
		Circles.create({
			...
			maxValue:<?=$survey_total?>,
			width:10,
			text: <?=$survey_total ? number_format(($survey_cukup_memuaskan/$survey_total)*100,0) : 0?>+'%',
		...
		Circles.create({
			...
			maxValue:<?=$survey_total?>,
			width:10,
			text: <?=$survey_total ? number_format(($survey_memuaskan/$survey_total)*100,0) : 0?>+'%',
		...
		Circles.create({
			...
			maxValue:<?=$survey_total?>,
			width:10,
			text: <?=$survey_total ? number_format(($survey_sangat_memuaskan/$survey_total)*100,0) : 0?>+'%',
